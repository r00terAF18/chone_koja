  ...
  <div class="room_card">
    <div class="box">
      ...
      <div class="columns mt-2">
        <div class="column">
          <a :href="room.link_to_site" class="button is-small is-link is-outlined"
            >مشاهده</a
          >
        </div>
        <div class="column">
        ...
        <div class="column">
          <button
            @click="remove_from_compare(room.id)"
...
export default {
  ...
  methods: {
    remove_from_compare(id) {
      this.$store.commit("remove_compare_id", id);
      this.$store.commit("addMessage", {
        type: "is-warning",
        message: "از لیست مقایسه حذف شد",
      });
    },
  },
};
